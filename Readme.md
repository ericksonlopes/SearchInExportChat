# Instalação 🛠️ 
[![tests](https://github.com/Erickson-lopes-dev/SearchInExportChat/actions/workflows/tests.yml/badge.svg)](https://github.com/Erickson-lopes-dev/SearchInExportChat/actions/workflows/tests.yml)
